...
def keyboard_change_report(info_report: Report) -> InlineKeyboardMarkup:
    ...
    button_2 = InlineKeyboardButton(text=f'Название операции: {info_report.title_action}',
                                    callback_data=f'change_report-title_action')
    button_3 = InlineKeyboardButton(text=f'Описание операции: {info_report.description_action}',
                                    callback_data=f'change_report_description_action')

    button_4 = InlineKeyboardButton(text=f'Наименование станка: {info_report.title_machine}',
                                    callback_data=f'change_report-title_machine')
    button_5 = InlineKeyboardButton(text=f'Наименование детали: {info_report.part_title}',
                                    callback_data=f'change_report-part_title')
    button_6 = InlineKeyboardButton(text=f'Машинное время: {info_report.machine_time}',
    ...
    button_9 = InlineKeyboardButton(text=f'Есть ли брак: {info_report.is_all_installed}',
                                    callback_data=f'change_report-is_all_installed')
    ...
    button_13 = InlineKeyboardButton(text=f'Начало работы: {info_report.data_create}',
                                     callback_data=f'change_report-data_create')
    button_14 = InlineKeyboardButton(text=f'Окончание работы: {info_report.data_complete}',
                                     callback_data=f'change_report-reason_defect')
